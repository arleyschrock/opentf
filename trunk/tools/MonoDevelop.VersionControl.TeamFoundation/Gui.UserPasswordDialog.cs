...
namespace MonoDevelop.VersionControl.TeamFoundation.Gui {
    ...
    public partial class UserPasswordDialog {
        ...
        protected virtual void Build() {
            ...
            // Widget MonoDevelop.VersionControl.TeamFoundation.Gui.UserPasswordDialog
            this.Events = ((Gdk.EventMask)(256));
            this.Name = "MonoDevelop.VersionControl.TeamFoundation.Gui.UserPasswordDialog";
            this.Title = Mono.Unix.Catalog.GetString("TeamFoundation");
            this.Modal = true;
            this.Resizable = false;
            this.AllowGrow = false;
            this.HasSeparator = true;
            // Internal child MonoDevelop.VersionControl.TeamFoundation.Gui.UserPasswordDialog.VBox
            ...
            this.label4.LabelProp = Mono.Unix.Catalog.GetString("<b>User credentials are required to access the TeamFoundation repository.</b>");
            ...
            w10.Position = 0;
            // Internal child MonoDevelop.VersionControl.TeamFoundation.Gui.UserPasswordDialog.ActionArea
            Gtk.HButtonBox w11 = this.ActionArea;
            w11.Events = ((Gdk.EventMask)(256));
            w11.Name = "MonoDevelop.VersionControl.TeamFoundation.UserPasswordDialog_ActionArea";
            w11.Spacing = 10;
            w11.BorderWidth = ((uint)(5));
            w11.LayoutStyle = ((Gtk.ButtonBoxStyle)(4));
            // Container child MonoDevelop.VersionControl.TeamFoundation.UserPasswordDialog_ActionArea.Gtk.ButtonBox+ButtonBoxChild
